...
int main() {
    int num_buckets = 31; // must be 2^i-1 where this is closest power of 2 above to the number of blocks you want to support - actually doesn't do anything
...
////*
    auto result1 = client.simple_access(5, 4, 0, {});
